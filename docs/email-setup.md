...
```
to:(r5young@ucsd.edu) AND (from:(dmarrama@lji.org OR dumar@salk.edu OR itam@salk.edu OR E***REMOVED***@scripps.edu OR dramanan@ucsd.edu) OR subject:(bill OR billing OR payment OR tuition OR housing OR deadline OR registration OR enroll OR enrollment OR "action required" OR hold OR financial OR refund OR "past due"))
```
...
```
to:(r5young@ucsd.edu) AND NOT (from:(dmarrama@lji.org OR dumar@salk.edu OR itam@salk.edu OR E***REMOVED***@scripps.edu OR dramanan@ucsd.edu) OR subject:(bill OR billing OR payment OR tuition OR housing OR deadline OR registration OR enroll OR enrollment OR "action required" OR hold OR financial OR refund OR "past due"))
```
